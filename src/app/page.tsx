    ...
    <div className="min-h-screen bg-cloud-white overflow-x-hidden">
      ...
      >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          {/* Credential badges */}
          <div className="mt-16 flex flex-wrap justify-center gap-4 scroll-animate opacity-0" style={{ animationDelay: "400ms" }}>
            ...
            <div className="inline-flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-full px-8 py-4 border border-white/10">
              ...
              <span className="text-xl font-semibold text-white">Certified Mediator</span>
            </div>
          </div>
        </div>
      </section>
